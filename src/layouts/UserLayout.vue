    ...
    <div class="user-shell" :class="{
        ...
        <div class="user-main__inner">
          ...
          <router-view v-else v-slot="{ Component, route: currentRoute }">
            <KeepAlive :include="keepAliveIncludes">
              <component :is="Component" v-if="Component && currentRoute.meta?.keepAlive"
      ...
      <aside v-if="!isMinimalPage" class="user-shell__right" aria-label="Playback panel">
        <div class="user-shell__right-scroll">
          <RightPanel id="right-player-panel" :queue="playerStore.queue" :current-music="playerStore.currentTrack"
...
import CreatePlaylists from '@/components/playlist/CreatePlaylists.vue'
import DeletePlaylistModal from '@/components/playlist/DeletePlaylistModal.vue'
