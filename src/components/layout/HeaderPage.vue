        ...
        <button class="brand brand-btn" type="button" @click="goHome" aria-label="Go home">
          ...
          <span v-if="!isXs" class="brand-copy">
            ...
            <span class="brand-sub">
              ...
              {{ isAdminPage ? 'Admin workspace' : authStore.user ? 'Your music space' : 'Premium listening' }}
          ...
          <div v-if="!isMobile" ref="profileRef" class="profile-wrap" @pointerdown.stop>
            ...
            <transition name="dropdown">
              ...
              <div v-if="menuOpen" class="profile-dropdown" role="menu" @pointerdown.stop>
                ...
                <button class="dropdown-item" type="button" role="menuitem" @click="nav(homePath)">
                ...
                <button class="dropdown-item" type="button" role="menuitem" @click="nav(profilePath)">
                ...
                <button class="dropdown-item" type="button" role="menuitem" @click="nav(settingsPath)">
                ...
                <button class="dropdown-item danger" type="button" :disabled="loggingOut" role="menuitem"
                  @click="logout">
